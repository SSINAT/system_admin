                ...
                <div class="card-body">
                    ...
                    <form class="form" action="{{ route('admin.product.update', $data->id) }}" method="POST"
                            ...
                            <div class="col-md-7">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        name="title" value="{{ $data->name }}" autocomplete="off">
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('harga') is-invalid @enderror"
                                        name="harga" value="{{ $data->price }}" autocomplete="off">
                                    @error('harga')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control @error('desc') is-invalid @enderror" id="summernote" name="desc" rows="3">{!! $data->body !!}</textarea>
                            @error('desc')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
